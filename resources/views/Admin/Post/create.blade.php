                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="post" action="{{ route('post.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-area id="body" name="body" type="text" class="mt-1 block w-full">{{ old('body') }}</x-text-area>
                        ...
                        <div>
                            ...
                            <x-select id="category_id" name="category_id" :options="$categories" class="mt-1 block w-full" :value="old('category_id')"/>
                        ...
                        <div>
                            <x-checkbox id="is_draft" name="is_draft" :label="__('Is Draft')" :checked="old('is_draft')"/>
