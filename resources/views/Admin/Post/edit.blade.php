                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="post" action="{{ route('post.update', $post) }}" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <x-text-area id="body" name="body" type="text"
                                class="mt-1 block w-full">{{ old('body', $post->body) }}</x-text-area>
                            <x-input-error class="mt-2" :messages="$errors->get('body')" />
                        </div>

                        <div>
                            <x-input-label for="image" :value="__('Image')" />
                            <x-file-input id="image" name="image" type="text" class="mt-1 block w-full"
                                :value="old('image')" accept=".jpeg,.jpg" />
                        ...
                        <div>
                            ...
                            <x-select id="category_id" name="category_id" :options="$categories" class="mt-1 block w-full"
                        ...
                        <div>
                            ...
                            <x-datetime id="published_at" name="published_at" class="mt-1 block w-full"
